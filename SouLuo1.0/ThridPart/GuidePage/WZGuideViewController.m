...
- (void)viewDidLoad
{
    ...
    NSArray *imageNameArray = [NSArray arrayWithObjects:@"3",@"yindao1", nil];
    ...
    self.pageScroll.contentSize = CGSizeMake(self.view.frame.size.width * imageNameArray.count, 0);
    ...
    for (int i = 0; i < imageNameArray.count; i++) {
        ...
        view = [[UIImageView alloc] initWithFrame:CGRectMake((self.view.frame.size.width * i), 0, self.view.frame.size.width, self.view.frame.size.height)];
        [view setImage:[UIImage imageNamed:imageNameArray[i]]];
        [_pageScroll addSubview:view];
        
        view.userInteractionEnabled=YES;
        
        if (i == imageNameArray.count - 1) {            
            UIButton *checkButton = [[UIButton alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height, 0, 0)];
            ...
            [enterButton setCenter:CGPointMake(self.view.center.x+120 , SCREEN_HEIGHT - 60)];
